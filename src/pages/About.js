...
// images
import AboutFeat from '../images/aboutfeat.jpg'
    ...
    return (
        <AboutPage>
                <div className={classes.overlay}>
                    <img className={classes.imgStyle} src={AboutFeat} alt='fauxels from Pexels' />  
                    <article className={classes.featureText}> 
                        <h2 className={classes.aboutTitle}>Who We Are</h2>
                        <Typography className={classes.featureBody} variant = 'body1'>Established in 2008 with a focus on: small business consulting, marketing firm conception, and existing business management. We take a modern approach to ensure that your business has utilized every resource available to you.
                        </Typography>
                    </article>
                </div>
                <article>
